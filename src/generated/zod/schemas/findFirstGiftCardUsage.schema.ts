...
export const GiftCardUsageFindFirstSelectSchema: z.ZodType<Prisma.GiftCardUsageSelect> = z.object({
...
export const GiftCardUsageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    giftCardId: z.boolean().optional(),
    orderId: z.boolean().optional(),
    amountUsed: z.boolean().optional(),
...
export const GiftCardUsageFindFirstSchema: z.ZodType<Prisma.GiftCardUsageFindFirstArgs> = z.object({ select: GiftCardUsageFindFirstSelectSchema.optional(), include: GiftCardUsageIncludeObjectSchema.optional(), orderBy: z.union([GiftCardUsageOrderByWithRelationInputObjectSchema, GiftCardUsageOrderByWithRelationInputObjectSchema.array()]).optional(), where: GiftCardUsageWhereInputObjectSchema.optional(), cursor: GiftCardUsageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GiftCardUsageScalarFieldEnumSchema, GiftCardUsageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GiftCardUsageFindFirstArgs>;

export const GiftCardUsageFindFirstZodSchema = z.object({ select: GiftCardUsageFindFirstSelectSchema.optional(), include: GiftCardUsageIncludeObjectSchema.optional(), orderBy: z.union([GiftCardUsageOrderByWithRelationInputObjectSchema, GiftCardUsageOrderByWithRelationInputObjectSchema.array()]).optional(), where: GiftCardUsageWhereInputObjectSchema.optional(), cursor: GiftCardUsageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GiftCardUsageScalarFieldEnumSchema, GiftCardUsageScalarFieldEnumSchema.array()]).optional() }).strict();