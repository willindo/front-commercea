...
export const GiftCardFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GiftCardSelect> = z.object({
...
export const GiftCardFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    userId: z.boolean().optional(),
    balance: z.boolean().optional(),
...
export const GiftCardFindFirstOrThrowSchema: z.ZodType<Prisma.GiftCardFindFirstOrThrowArgs> = z.object({ select: GiftCardFindFirstOrThrowSelectSchema.optional(), include: GiftCardIncludeObjectSchema.optional(), orderBy: z.union([GiftCardOrderByWithRelationInputObjectSchema, GiftCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: GiftCardWhereInputObjectSchema.optional(), cursor: GiftCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GiftCardScalarFieldEnumSchema, GiftCardScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GiftCardFindFirstOrThrowArgs>;

export const GiftCardFindFirstOrThrowZodSchema = z.object({ select: GiftCardFindFirstOrThrowSelectSchema.optional(), include: GiftCardIncludeObjectSchema.optional(), orderBy: z.union([GiftCardOrderByWithRelationInputObjectSchema, GiftCardOrderByWithRelationInputObjectSchema.array()]).optional(), where: GiftCardWhereInputObjectSchema.optional(), cursor: GiftCardWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GiftCardScalarFieldEnumSchema, GiftCardScalarFieldEnumSchema.array()]).optional() }).strict();