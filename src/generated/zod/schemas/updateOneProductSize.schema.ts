...
export const ProductSizeUpdateOneSchema: z.ZodType<any> = z.object({ select: ProductSizeSelectObjectSchema.optional(), include: ProductSizeIncludeObjectSchema.optional(), data: z.union([ProductSizeUpdateInputObjectSchema, ProductSizeUncheckedUpdateInputObjectSchema]), where: ProductSizeWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<any>;
