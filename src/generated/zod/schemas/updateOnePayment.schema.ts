...
export const PaymentUpdateOneSchema: z.ZodType<any> = z.object({ select: PaymentSelectObjectSchema.optional(), include: PaymentIncludeObjectSchema.optional(), data: z.union([PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema]), where: PaymentWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<any>;
