...
export const WishlistUpdateOneSchema: z.ZodType<any> = z.object({ select: WishlistSelectObjectSchema.optional(), include: WishlistIncludeObjectSchema.optional(), data: z.union([WishlistUpdateInputObjectSchema, WishlistUncheckedUpdateInputObjectSchema]), where: WishlistWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<any>;
