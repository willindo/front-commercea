...
export const PaymentCreateOneSchema: z.ZodType<any> = z.object({ select: PaymentSelectObjectSchema.optional(), include: PaymentIncludeObjectSchema.optional(), data: z.union([PaymentCreateInputObjectSchema, PaymentUncheckedCreateInputObjectSchema]) }).strict() as unknown as z.ZodType<any>;
