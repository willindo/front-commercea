...
export const OrderItemUpdateManyAndReturnSchema: z.ZodType<any> = z.object({ select: OrderItemSelectObjectSchema.optional(), data: OrderItemUpdateManyMutationInputObjectSchema, where: OrderItemWhereInputObjectSchema.optional() }).strict() as unknown as z.ZodType<any>;
