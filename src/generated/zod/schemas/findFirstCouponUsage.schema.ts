...
export const CouponUsageFindFirstSelectSchema: z.ZodType<Prisma.CouponUsageSelect> = z.object({
...
export const CouponUsageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    coupon: z.boolean().optional(),
    couponId: z.boolean().optional(),
    user: z.boolean().optional(),
