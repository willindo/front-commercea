...
export const CartItemUpdateOneSchema: z.ZodType<any> = z.object({ select: CartItemSelectObjectSchema.optional(), include: CartItemIncludeObjectSchema.optional(), data: z.union([CartItemUpdateInputObjectSchema, CartItemUncheckedUpdateInputObjectSchema]), where: CartItemWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<any>;
