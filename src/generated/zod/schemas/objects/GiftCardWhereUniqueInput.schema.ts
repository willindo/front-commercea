...
const makeSchema = () => z.object({
  ...
  code: z.string().optional()
        ...
        const singles: string[] = ["id","code"] as string[];
...
export const GiftCardWhereUniqueInputObjectSchema: z.ZodType<Prisma.GiftCardWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.GiftCardWhereUniqueInput>;
export const GiftCardWhereUniqueInputObjectZodSchema = makeSchema();
