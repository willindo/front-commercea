...
export const WishlistUpsertOneSchema: z.ZodType<any> = z.object({ select: WishlistSelectObjectSchema.optional(), include: WishlistIncludeObjectSchema.optional(), where: WishlistWhereUniqueInputObjectSchema, create: z.union([ WishlistCreateInputObjectSchema, WishlistUncheckedCreateInputObjectSchema ]), update: z.union([ WishlistUpdateInputObjectSchema, WishlistUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<any>;
